    ...
    <main className="legal-page">
      ...
      <div className="legal-page__container">
        ...
        <section>
          ...
          <p>
            Anthony Nivault s'engage à protéger la vie privée
            des visiteurs de son portfolio. Cette politique de
        ...
        <section>
          ...
          <p>
            Ces informations sont fournies volontairement
            par l'utilisateur afin d'entrer en contact avec
            l'éditeur du site.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            pour répondre aux demandes envoyées via le formulaire
            de contact.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Les données transmises via le formulaire de contact
            sont destinées exclusivement à Anthony Nivault.
          </p>

          <p>
            Afin de permettre l'envoi des messages, les données
            peuvent transiter par le service EmailJS.
          </p>
        ...
        <section>
          ...
          <p>
            Les messages reçus via le formulaire de contact sont
        ...
        <section>
          ...
          <p>
            ...
            de suivi marketing ou d'analyse d'audience.
          </p>
        ...
        <section>
          ...
          <p>
            Des mesures techniques et organisationnelles sont
            mises en œuvre afin de protéger les données contre
        ...
        <section>
          ...
          <p>
            Cette politique de confidentialité peut être mise à
            jour à tout moment afin de refléter l'évolution du
        ...
        <section>
          ...
          <p>
            ...
            confidentialité, vous pouvez utiliser le formulaire
            de contact du site.
          </p>
        </section>
